export const emailVerificationTemplate = (otp: string, name: string) => {
	return (`
        <!DOCTYPE html>
        <html>
            <head>
            ...
            <body>
                <div class="container">
                    <div class="message">OTP for Email Verification</div>
                    <div class="body">
                        <p>Dear ${name}</p>
                        <p>
                            Thank you for registering with BharatKatha. To complete your registration, please use the following OTP
